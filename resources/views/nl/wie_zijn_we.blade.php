...
<div class="container mt-3 pt-4 py-0 p-md-5 ">
     ...
     <div style=" background-color: hsl(141, 64%, 30%); margin-top:6rem;" class=" p-2 p-sm-5  text-white rounded ">
    ...
    <p>Een non-profitorganisatie die wordt beheerd en
       ...
       <div style="background-color:#1e7e34  " class="mt-3 p-2 p-sm-5 text-white rounded animate__animated animate__fadeInUp animate__delay-2s ">
    ...
    <p> Het doel is om zoveel mogelijk Egyptenaren de
         ...
         <div style="background-color:#1e7e34;" class="mt-3 p-2 p-sm-5  text-white rounded animate__animated animate__fadeInUp animate__delay-3s ">
