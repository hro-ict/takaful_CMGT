 <div class="content was-validated" >
 <form method="POST" action= "{{ route('save_register') }}" class= "animate__animated animate__fadeInDown animate__delay-1s bg-info px-3">
    @csrf
  
<div class="persoonlijke_gegevens">
  <div class="form-outline mb-4">
        <label class="form-label fw-bold " for="Naam_aanmelder">Voor- en achternaam aanmelder
          <br>
          الاسم الأول واللقب
        </label>
    ...
    <div class="invalid-feedback">
      <span class="fw-bold">Verplicht</span>
    </div>
  </div>
  ...
  <!-- Text input -->
  <div class="form-outline mb-4">
      <label class="form-label fw-bold " for="Geboortedatum_aanmelder">Geboortedatum
        <br>
        تاريخ الولادة
      </label>
  ...
  <!-- Text input -->
  <div class="form-outline mb-4">
      <label class="form-label fw-bold" for="Naam_van_echthgenote">Naam Echtgenote
        <br>
        اسم الزوجة
      </label>
  ...
  <div class="form-outline mb-4">
       <label class="form-label fw-bold" for="Geboortedatum_van_echthgenote">Geboortedatum-Echtgenote
        <br>
        تاريخ الميلاد-الزوجة
       </label>
  ...
  <button id="add_kids" type="button" class="btn btn-danger w-100 mt-3 mb-3">Voeg een kind toe 
    <br>
    أضف طفل
  </button>
  ...
  <div class="form-outline mb-4">
            <label class="form-label fw-bold " for="Adress">Adres
              <br>
              عنوان
            </label>
        ...
        <div class="form-outline mb-4">
             <label class="form-label fw-bold" for="Telefoonnummer">Telefoonnummer
              <br>
              رقم الهاتف
             </label>
  ...
  <div class="form-outline mb-4">
       <label class="form-label fw-bold " for="Nationaliteit">Afkomst/Nationaliteit
        <br>
        الأصل / الجنسية
       </label>
...
<div class="col-6"><span class="fw-bold">Keuze begraafplaats
<br>
أن یكون الدفن في   
</span></div>

<div class="col-6">
     <input class="form-check-input" name="Keuze_begraafplaats" type="radio" id="inlineCheckbox2" value="Nederland" required>
...
<div class="d-flex border border-3  py-3">
<div class="col-6"><span class="fw-bold">Heeft u uitvaartverzekering?
<br>
ھل لدیك تأمین للدفن  
</span></div>

<div class="col-6">
     <input class="form-check-input" name="Heeft_uitvaartverzekering" type="radio" id="inlineCheckbox2" value="JA" required>
  <label class="form-check-label" for="inlineCheckbox1"><span class="fw-bold">JA</span></label>
   <input class="form-check-input" name="Heeft_uitvaartverzekering" type="radio" id="inlineCheckbox2" value="NEE" required>
...
<div class="col-6"><span class="fw-bold">Wilt u de gegevens van de verzekeringsmaatschappij doorgeven aan TAKAFUL
<br>
ھل ترغب في إعطاء معلومات شركة التأمین لصندوق التكافل الاجتماعي  
</span></div>
...
<div class="col-6">
 ...
 <div id="gegevens_doorgeven_verzekeringsmaatschappij" class="form-outline mt-3 mb-4 d-none">
      <label class="form-label fw-bold " for="Adress">Naam van verzekeringsmaatschappij
        <br>
        اسم شركة التأمين
      </label>
...
<!--Uitvaartverzekering-->
  ...
  <!-- Message input -->
  <div class="form-outline mb-4">
       <label class="form-label fw-bold" for="Message">Message
        <br>
        رسالة
       </label>
  ...
  <!--<label class="accept" for="accept">-->
    <span class="h6 gy-3" style="cursor:grab" id="accept_text">Ik accepteer <u> <strong>
      <a href="https://takaful.nl/algemene_voorwaarden" target="blank_">
      alle voorwaarden
      </a>
    </strong></u></span>
  <!--</label>-->
...
$.ajaxSetup({
   ...
   count_kids=0
    ...
    $("#add_kids").click(function(){
        count_kids+=1
          //html= '<div class="form-outline mb-4"><label clas="form-label" for="form_kind_%s"><b>Naam Kind %s</b></label><input type="text" name="Naam_kind_%s"id="form_kind_%s" class="form-control" /></div><div class="form-outline mb-4"><label class="form-label fw-bold" for="geboortedatum_kind_%s">Geboortedatum Kind %s</label><input type="text" id="birthday_of_partner" name="Geboortedatum kind %s" class="form-control datepicker" required/></div>'.format(count_kids, count_kids, count_kids, count_kids, count_kids, count_kids, count_kids)
        html= `<div class="form-outline mb-4"><label clas="form-label" for="form_kind_${count_kids}"><b>Naam Kind ${count_kids}</b></label><input type="text" name="Naam_kind_${count_kids}"id="form_kind_${count_kids}" class="form-control" /></div><div class="form-outline mb-4"><label class="form-label fw-bold" for="geboortedatum_kind_${count_kids}">Geboortedatum Kind ${count_kids}</label><input type="text" id="geboortedatum_kind_${count_kids}" name="Geboortedatum kind ${count_kids}" class="form-control datepicker2" required/></div>`
        setTimeout(() => {
