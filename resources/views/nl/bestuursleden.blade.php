...
<div class="d-flex flex-wrap flex-md-nowrap " role="group" aria-label="Basic radio toggle button group">
    <div class="card  w-50">
      <img width="200" height="268" src="{{ asset('img/bestuur/new/voorzitter.jpeg') }}" class="card-img-top "
        alt="Voorzitter" />
    ...
    <div id="register_form" class="card  w-50">
      <img width="200" height="268" src="{{ asset('img/bestuur/new/secretaris.jpeg') }}" class="card-img-top"
    ...
    <div class="card  w-50">
      <img width="200" height="268" src="{{ asset('img/bestuur/new/raad_van_bestuurslid_1.jpeg') }}" class="card-img-top"
        alt="Hollywood Sign on The Hill" />
      <div class="card-body d-flex flex-column">
    ...
    <div class="card   w-50">
      <img width="200" height="268" src="{{ asset('img/bestuur/new/raad_van_bestuurslid_2.jpeg') }}" class="card-img-top "
        alt="Hollywood Sign on The Hill" />
      <div class="card-body d-flex flex-column">
        <h6 class="card-title">Raad van bestuurslid</h6>
        <p class="card-text">
    ...
    <div class="card   w-50">
        <img width="200" height="268" src="{{ asset('img/bestuur/new/penningmeester.png') }}" class="card-img-top "
          alt="Hollywood Sign on The Hill" />
        <div class="card-body d-flex flex-column">
...
//        $("#phone_about").attr("href","tel:%s".format(data.phone))
    ...
    $("#about_img").attr("src", "{{ asset('img/bestuur/new/%s') }}".format(data.image))
