 <div class="content">
 <form method="POST" action= "{{ route('save_register_single') }}" class="bg-info px-3">
    @csrf
  
 
  <div class="form-outline mb-4">
        <label class="form-label fw-bold " for="name">Naam aanmelder</label>
  ...
  <!-- Text input -->
  <div class="form-outline mb-4">
      <label class="form-label fw-bold " for="birthday">Geboortedatum aanmelder</label>
  ...
  <div class="form-outline mb-4">
       <label class="form-label fw-bold " for="nationality">Nationaliteit</label>
...
{{-- test --}}
  ...
  <!--<label class="accept" for="accept">-->
    <span class="h6 gy-3" style="cursor:grab" id="accept_text">Ik accepteer <u> <strong>algemene voorwaarden</strong></u></span>
  <!--</label>-->
...
Swal.fire({
  ...
  if (result.isConfirmed) {
     location.href= "/";
      ...
      Swal.fire("",  "U moet algemene voorwaarden accepteren", "error");
