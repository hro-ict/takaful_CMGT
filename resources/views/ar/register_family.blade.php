...
<h3> <span class="badge bg-primary text-center">معلومات شخصية</span></h3>
  ...
  <!-- Text input -->
  <div class="form-outline mb-4">
      <label class="form-label fw-bold " for="birthday">تاريخ الميلاد </label>
  ...
  <button id="add_kids" type="button" class="btn btn-info w-100 mt-3 mb-3">أضف طفل</button>
...
{{-- test --}}
 <h3> <span class="badge bg-info mt-5">بيانات المتصل</span></h3>
...
<!--keuze begraafplaats-->
 <h3> <span class="badge bg-danger mt-2">مقبرة الاختيار</span></h3>
<div class="d-flex border border-3  py-3">
<div class="col-6"><span class="fw-bold">ارغب ان يكون الدفن في</span></div>
...
<h3> <span class="badge bg-success mt-2">معلومات تأميین للدفن</span></h3>
...
<div class="gegevens_van_verzekeringsmaatschappij d-none">
 ...
 <div id="gegevens_doorgeven_verzekeringsmaatschappij" class="form-outline mt-3 mb-4">
      <label class="form-label fw-bold " for="Adres_van_verzekeringsmaatschappij">عنوان شركة التأمين</label>
 ...
 <div id="" class="form-outline mt-3 mb-4 ">
      <label class="form-label fw-bold " for="Telefoonnummer_van_verzekeringsmaatschappij">رقم هاتف شركة التأمين</label>
