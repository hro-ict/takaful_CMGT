...
Route::post("/save_register",[Takaful::class, 'save_register'])->name('save_register');

Route::post("/save_register_family",[Takaful::class, 'save_register_family'])->name('save_register_family');

Route::post("/save_register_single",[Takaful::class, 'save_register_single'])->name('save_register_single');
